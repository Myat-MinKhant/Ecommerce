        ...
        <div>
            {cartItems.length === 0 ? (
                ...
                <div className=' bg-second w-full h-fit'>
                    <Container className='laptop:flex h-fit py-10 laptop:px-14 '>
                        <Box className=' laptop:w-4/6 pt-10 mb-10 rounded-xl bg-white laptop:px-10 laptop:ml-6 shadow-xl'>
                                ...
                                <Table aria-label="spanning-table">
                                    <TableHead>
                                        ...
                                        <TableRow>
                                            ...
                                            <TableCell className='uppercase col-span-1' align="right">Price</TableCell>
                                        </TableRow>
                                    </TableHead>
                                    <TableBody>
                                        {cartItems.map(item => (
                                            <TableRow className='cart_product_list' key={item.id}>
                                                ...
                                                <TableCell align="right" className=' text-lg font-main'>${item.price}</TableCell>
                                                <TableCell align="right"
                                                    className=' text-lg font-main'>${item.price * item.quantity}
                                                </TableCell>
                                            </TableRow>
                                        ))}
                                        <TableRow>
                            ...
                            <TableContainer component={Paper} className=" tablet:hidden w-full">
                                <Table aria-label="spanning-table">
                                    <TableHead>
                                    ...
                                    <TableBody>
                                        {cartItems.map(item => (
                                            <TableRow className='cart_product_list' key={item.id}>
                                                ...
                                                <TableCell align="right" className=' text-lg flex flex-col items-end h-52 justify-around'>
                                                    <Box>
                                                        <Button
                                                            variant="contained"
                                                            className='min-w-fit min-h-fit bg-gray-300 text-dark shadow-none font-bold mr-2'
                        ...
                        <Box className='laptop:w-3/6'>
                            <Box className='flex flex-col gap-2 bg-white pt-16 rounded-xl laptop:w-96 pb-10 laptop:ml-10 mt-10 laptop:mt-0 shadow-xl' position={'sticky'}>
